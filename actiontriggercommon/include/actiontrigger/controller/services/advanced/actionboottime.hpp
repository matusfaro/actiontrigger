...
#ifndef ActionBootTime_HPP_
#define ActionBootTime_HPP_
...
namespace actiontrigger
{
    ...
    class ActionBootTime: public Action
    {
    public:
        ActionBootTime(StatementModel* model);
        virtual ~ActionBootTime();
