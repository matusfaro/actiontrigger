...
#ifndef ActionClearNetworkUsage_HPP_
#define ActionClearNetworkUsage_HPP_
...
namespace actiontrigger
{
    ...
    class ActionClearNetworkUsage: public Action
    {
    public:
        ActionClearNetworkUsage(StatementModel* model);
        virtual ~ActionClearNetworkUsage();
...
#endif /* ActionClearNetworkUsage_HPP_ */
