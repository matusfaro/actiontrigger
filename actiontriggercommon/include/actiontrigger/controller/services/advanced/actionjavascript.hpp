...
#ifndef ActionJavascript_HPP_
#define ActionJavascript_HPP_
...
namespace actiontrigger
{
    ...
    class ActionJavascript: public Action
    {
    public:
        ActionJavascript(StatementModel* model);
        virtual ~ActionJavascript();
