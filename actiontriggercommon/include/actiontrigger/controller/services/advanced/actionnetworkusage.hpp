...
#ifndef ActionNetworkUsage_HPP_
#define ActionNetworkUsage_HPP_
...
namespace actiontrigger
{
    ...
    class ActionNetworkUsage: public Action
    {
    public:
        ActionNetworkUsage(StatementModel* model);
        virtual ~ActionNetworkUsage();
