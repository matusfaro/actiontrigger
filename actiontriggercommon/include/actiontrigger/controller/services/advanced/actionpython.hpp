...
#ifndef ActionPython_HPP_
#define ActionPython_HPP_
...
namespace actiontrigger
{
    ...
    class ActionPython: public Action
    {
    public:
        ActionPython(StatementModel* model);
        virtual ~ActionPython();
