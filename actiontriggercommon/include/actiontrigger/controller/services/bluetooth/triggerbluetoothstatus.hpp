...
#ifndef TriggerBluetoothStatus_HPP_
#define TriggerBluetoothStatus_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerBluetoothStatus: public Trigger
    {
    public:
        TriggerBluetoothStatus(StatementModel* model);
...
#endif /* TriggerBluetoothStatus_HPP_ */
