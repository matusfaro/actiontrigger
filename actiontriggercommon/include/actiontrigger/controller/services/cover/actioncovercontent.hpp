...
#ifndef ActionCoverContent_HPP_
#define ActionCoverContent_HPP_
...
namespace actiontrigger
{
    ...
    class ActionCoverContent: public Action
    {
    public:
        ActionCoverContent(StatementModel* model);
        virtual ~ActionCoverContent();
