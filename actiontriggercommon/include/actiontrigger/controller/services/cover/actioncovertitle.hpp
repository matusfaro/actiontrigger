...
#ifndef ActionCoverTitle_HPP_
#define ActionCoverTitle_HPP_
...
namespace actiontrigger
{
    ...
    class ActionCoverTitle: public Action
    {
    public:
        ActionCoverTitle(StatementModel* model);
        virtual ~ActionCoverTitle();
