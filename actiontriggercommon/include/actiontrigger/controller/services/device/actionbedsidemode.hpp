...
#ifndef ActionBedsideMode_HPP_
#define ActionBedsideMode_HPP_
...
namespace actiontrigger
{
    ...
    class ActionBedsideMode: public Action
    {
    public:
        static bool isSupported();
        ActionBedsideMode(StatementModel* model);
        virtual ~ActionBedsideMode();
