...
#ifndef ActionGetClipboard_HPP_
#define ActionGetClipboard_HPP_
...
namespace actiontrigger
{
    ...
    class ActionGetClipboard: public Action
    {
    public:
        ActionGetClipboard(StatementModel* model);
        virtual ~ActionGetClipboard();
