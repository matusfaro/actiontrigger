...
#ifndef ActionGetProfile_HPP_
#define ActionGetProfile_HPP_
...
namespace actiontrigger
{
    ...
    class ActionGetProfile: public Action
    {
    public:
        ActionGetProfile(StatementModel* model);
        virtual ~ActionGetProfile();
