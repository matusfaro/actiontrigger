...
#ifndef ActionHolster_HPP_
#define ActionHolster_HPP_
...
namespace actiontrigger
{
    ...
    class ActionHolster: public Action
    {
    public:
        static bool isSupported();
        ActionHolster(StatementModel* model);
        virtual ~ActionHolster();
