...
#ifndef ActionSetClipboard_HPP_
#define ActionSetClipboard_HPP_
...
namespace actiontrigger
{
    ...
    class ActionSetClipboard: public Action
    {
    public:
        ActionSetClipboard(StatementModel* model);
        virtual ~ActionSetClipboard();
