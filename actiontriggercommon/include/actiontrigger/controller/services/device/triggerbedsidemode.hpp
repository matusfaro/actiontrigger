...
#ifndef TriggerBedsideMode_HPP_
#define TriggerBedsideMode_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerBedsideMode: public TriggerValue
    {
    public:
        TriggerBedsideMode(StatementModel* model);
        ~TriggerBedsideMode();
