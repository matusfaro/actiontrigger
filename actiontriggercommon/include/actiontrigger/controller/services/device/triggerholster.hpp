...
#ifndef TriggerHolster_HPP_
#define TriggerHolster_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerHolster: public TriggerValue
    {
    public:
        TriggerHolster(StatementModel* model);
        ~TriggerHolster();
