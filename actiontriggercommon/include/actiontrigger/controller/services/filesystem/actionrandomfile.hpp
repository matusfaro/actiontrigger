...
#ifndef ActionRandomFile_HPP_
#define ActionRandomFile_HPP_
...
namespace actiontrigger
{
    ...
    class ActionRandomFile: public Action
    {
    public:
        ActionRandomFile(StatementModel* model);
        virtual ~ActionRandomFile();
