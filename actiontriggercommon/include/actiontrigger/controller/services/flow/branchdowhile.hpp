...
#ifndef BranchDoWhile_HPP_
#define BranchDoWhile_HPP_
...
namespace actiontrigger
{
    ...
    class BranchDoWhile: public Branch
    {
    public:
        BranchDoWhile(StatementModel* model);
        virtual ~BranchDoWhile();
