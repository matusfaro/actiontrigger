...
#ifndef BranchIfThen_HPP_
#define BranchIfThen_HPP_
...
namespace actiontrigger
{
    ...
    class BranchIfThen: public Branch
    {
    public:
        BranchIfThen(StatementModel* model);
        virtual ~BranchIfThen();
