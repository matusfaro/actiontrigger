...
#ifndef GEOLOCATIONRETRIEVE_HPP_
#define GEOLOCATIONRETRIEVE_HPP_
...
namespace actiontrigger
{
    ...
    class ActionGeoLocationRetrieve: public Action
    {
    public:
        ActionGeoLocationRetrieve(StatementModel* model);
        virtual ~ActionGeoLocationRetrieve();
...
#endif /* GEOLOCATIONRETRIEVE_HPP_ */
