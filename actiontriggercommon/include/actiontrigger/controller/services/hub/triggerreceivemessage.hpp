...
#ifndef TriggerReceiveMessage_HPP_
#define TriggerReceiveMessage_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerReceiveMessage: public Trigger
    {
    public:
        TriggerReceiveMessage(StatementModel* model);
...
#endif /* TriggerReceiveMessage_HPP_ */
