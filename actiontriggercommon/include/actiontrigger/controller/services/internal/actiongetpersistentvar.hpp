...
#ifndef ActionGetPersistentVar_HPP_
#define ActionGetPersistentVar_HPP_
...
namespace actiontrigger
{
    ...
    class ActionGetPersistentVar: public Action
    {
    public:
        ActionGetPersistentVar(StatementModel* model);
        virtual ~ActionGetPersistentVar();
...
#endif /* ActionGetPersistentVar_HPP_ */
