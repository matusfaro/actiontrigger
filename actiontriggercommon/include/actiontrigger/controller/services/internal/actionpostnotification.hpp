...
#ifndef ActionPostNotification_HPP_
#define ActionPostNotification_HPP_
...
namespace actiontrigger
{
    ...
    class ActionPostNotification: public Action
    {
    public:
        ActionPostNotification(StatementModel* model);
        virtual ~ActionPostNotification();
...
#endif /* ActionPostNotification_HPP_ */
