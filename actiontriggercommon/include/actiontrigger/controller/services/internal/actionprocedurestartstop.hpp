...
#ifndef ActionProcedureStartStop_HPP_
#define ActionProcedureStartStop_HPP_
...
namespace actiontrigger
{
    ...
    class ActionProcedureStartStop: public Action
    {
    public:
        ActionProcedureStartStop(StatementModel* model);
        virtual ~ActionProcedureStartStop();
...
#endif /* ActionProcedureStartStop_HPP_ */
