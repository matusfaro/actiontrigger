...
#ifndef ActionSetGlobalVar_HPP_
#define ActionSetGlobalVar_HPP_
...
namespace actiontrigger
{
    ...
    class ActionSetGlobalVar: public Action
    {
    public:
        ActionSetGlobalVar(StatementModel* model);
        virtual ~ActionSetGlobalVar();
