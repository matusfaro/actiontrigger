...
#ifndef ActionSetVar_HPP_
#define ActionSetVar_HPP_
...
namespace actiontrigger
{
    ...
    class ActionSetVar: public Action
    {
    public:
        ActionSetVar(StatementModel* model);
        virtual ~ActionSetVar();
