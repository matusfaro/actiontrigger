...
#ifndef ActionInvokeBbm_HPP_
#define ActionInvokeBbm_HPP_
...
namespace actiontrigger
{
    ...
    class ActionInvokeBbm: public Action
    {
    public:
        ActionInvokeBbm(StatementModel* model);
        virtual ~ActionInvokeBbm();
