...
#ifndef ActionInvokeCustom_HPP_
#define ActionInvokeCustom_HPP_
...
namespace actiontrigger
{
    ...
    class ActionInvokeCustom: public Action
    {
    public:
        ActionInvokeCustom(StatementModel* model);
        virtual ~ActionInvokeCustom();
