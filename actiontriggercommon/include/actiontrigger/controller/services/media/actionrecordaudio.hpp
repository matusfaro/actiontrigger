...
#ifndef ActionRecordAudio_HPP_
#define ActionRecordAudio_HPP_
...
namespace actiontrigger
{
    ...
    class ActionRecordAudio: public Action
    {
    public:
        ActionRecordAudio(StatementModel* model);
        virtual ~ActionRecordAudio();
