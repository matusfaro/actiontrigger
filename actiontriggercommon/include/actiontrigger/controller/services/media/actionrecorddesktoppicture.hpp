...
#ifndef ActionRecordDesktopPicture_HPP_
#define ActionRecordDesktopPicture_HPP_
...
namespace actiontrigger
{
    ...
    class ActionRecordDesktopPicture: public Action
    {
    public:
        ActionRecordDesktopPicture(StatementModel* model);
        virtual ~ActionRecordDesktopPicture();
    ...
    private:
        ...
        static void photoRecordingStatusCallback(camera_handle_t handle, camera_buffer_t* buf,
                void *context);
    };

} /* namespace actiontrigger */
#endif /* ActionRecordDesktopPicture_HPP_ */
