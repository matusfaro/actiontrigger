...
#ifndef ActionRecordPicture_HPP_
#define ActionRecordPicture_HPP_
...
namespace actiontrigger
{
    ...
    class ActionRecordPicture: public Action
    {
    public:
        ActionRecordPicture(StatementModel* model);
        virtual ~ActionRecordPicture();
...
#endif /* ActionRecordPicture_HPP_ */
