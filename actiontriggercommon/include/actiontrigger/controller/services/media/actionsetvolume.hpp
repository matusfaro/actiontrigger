...
#ifndef ActionSetVolume_HPP_
#define ActionSetVolume_HPP_
...
namespace actiontrigger
{
    ...
    class ActionSetVolume: public Action
    {
    public:
        ActionSetVolume(StatementModel* model);
        virtual ~ActionSetVolume();
