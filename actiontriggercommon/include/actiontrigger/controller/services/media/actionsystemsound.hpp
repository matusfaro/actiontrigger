...
#ifndef ActionSystemSound_HPP_
#define ActionSystemSound_HPP_
...
namespace actiontrigger
{
    ...
    class ActionSystemSound: public Action
    {
    public:
        ActionSystemSound(StatementModel* model);
        virtual ~ActionSystemSound();
