...
#ifndef StatementCorrupt_HPP_
#define StatementCorrupt_HPP_
...
namespace actiontrigger
{
    ...
    /**
     * Special placeholder for corrupted or missing statements.
     */
    class StatementCorrupt: public Trigger
    {
    public:
        StatementCorrupt(StatementModel* model);
        ~StatementCorrupt();
