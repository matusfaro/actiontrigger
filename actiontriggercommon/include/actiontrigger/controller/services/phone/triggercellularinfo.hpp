...
#ifndef TriggerCellularInfo_HPP_
#define TriggerCellularInfo_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerCellularInfo: public TriggerValue
    {
    public:
        TriggerCellularInfo(StatementModel* model);
        ~TriggerCellularInfo();
...
#endif /* TriggerCellularInfo_HPP_ */
