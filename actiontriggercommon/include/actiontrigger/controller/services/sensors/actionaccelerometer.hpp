...
#ifndef ActionAccelerometer_HPP_
#define ActionAccelerometer_HPP_
...
namespace actiontrigger
{
    ...
    class ActionAccelerometer: public Action
    {
    public:
        static bool isSupported();
        ActionAccelerometer(StatementModel* model);
        virtual ~ActionAccelerometer();
...
#endif /* ActionAccelerometer_HPP_ */
