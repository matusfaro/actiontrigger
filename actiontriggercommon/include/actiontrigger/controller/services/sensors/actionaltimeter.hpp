...
#ifndef ActionAltimeter_HPP_
#define ActionAltimeter_HPP_
...
namespace actiontrigger
{
    ...
    class ActionAltimeter: public Action
    {
    public:
        static bool isSupported();
        ActionAltimeter(StatementModel* model);
        virtual ~ActionAltimeter();
