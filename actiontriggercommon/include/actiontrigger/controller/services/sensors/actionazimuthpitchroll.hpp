...
#ifndef ActionAzimuthPitchRoll_HPP_
#define ActionAzimuthPitchRoll_HPP_
...
namespace actiontrigger
{
    ...
    class ActionAzimuthPitchRoll: public Action
    {
    public:
        static bool isSupported();
        ActionAzimuthPitchRoll(StatementModel* model);
        virtual ~ActionAzimuthPitchRoll();
...
#endif /* ActionAzimuthPitchRoll_HPP_ */
