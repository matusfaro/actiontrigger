...
#ifndef ActionCompass_HPP_
#define ActionCompass_HPP_
...
namespace actiontrigger
{
    ...
    class ActionCompass: public Action
    {
    public:
        static bool isSupported();
        ActionCompass(StatementModel* model);
        virtual ~ActionCompass();
