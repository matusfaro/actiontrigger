...
#ifndef ActionGravity_HPP_
#define ActionGravity_HPP_
...
namespace actiontrigger
{
    ...
    class ActionGravity: public Action
    {
    public:
        static bool isSupported();
        ActionGravity(StatementModel* model);
        virtual ~ActionGravity();
