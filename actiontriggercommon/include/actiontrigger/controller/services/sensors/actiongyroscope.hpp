...
#ifndef ActionGyroscope_HPP_
#define ActionGyroscope_HPP_
...
namespace actiontrigger
{
    ...
    class ActionGyroscope: public Action
    {
    public:
        static bool isSupported();
        ActionGyroscope(StatementModel* model);
        virtual ~ActionGyroscope();
