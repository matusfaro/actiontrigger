...
#ifndef ActionMagnetometer_HPP_
#define ActionMagnetometer_HPP_
...
namespace actiontrigger
{
    ...
    class ActionMagnetometer: public Action
    {
    public:
        static bool isSupported();
        ActionMagnetometer(StatementModel* model);
        virtual ~ActionMagnetometer();
