...
#ifndef ActionPressure_HPP_
#define ActionPressure_HPP_
...
namespace actiontrigger
{
    ...
    class ActionPressure: public Action
    {
    public:
        static bool isSupported();
        ActionPressure(StatementModel* model);
        virtual ~ActionPressure();
