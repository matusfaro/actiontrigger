...
#ifndef ActionProximity_HPP_
#define ActionProximity_HPP_
...
namespace actiontrigger
{
    ...
    class ActionProximity: public Action
    {
    public:
        static bool isSupported();
        ActionProximity(StatementModel* model);
        virtual ~ActionProximity();
