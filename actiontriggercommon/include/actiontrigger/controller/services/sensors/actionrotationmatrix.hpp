...
#ifndef ActionRotationMatrix_HPP_
#define ActionRotationMatrix_HPP_
...
namespace actiontrigger
{
    ...
    class ActionRotationMatrix: public Action
    {
    public:
        static bool isSupported();
        ActionRotationMatrix(StatementModel* model);
        virtual ~ActionRotationMatrix();
...
#endif /* ActionRotationMatrix_HPP_ */
