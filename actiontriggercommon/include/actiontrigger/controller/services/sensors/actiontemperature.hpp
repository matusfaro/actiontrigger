...
#ifndef ActionTemperature_HPP_
#define ActionTemperature_HPP_
...
namespace actiontrigger
{
    ...
    class ActionTemperature: public Action
    {
    public:
        static bool isSupported();
        ActionTemperature(StatementModel* model);
        virtual ~ActionTemperature();
