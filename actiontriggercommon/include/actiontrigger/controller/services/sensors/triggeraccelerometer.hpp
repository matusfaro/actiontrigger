...
#ifndef TriggerAccelerometer_HPP_
#define TriggerAccelerometer_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerAccelerometer: public TriggerValue
    {
    public:
        TriggerAccelerometer(StatementModel* model);
...
#endif /* TriggerAccelerometer_HPP_ */
