...
#ifndef TriggerAltimeter_HPP_
#define TriggerAltimeter_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerAltimeter: public TriggerValue
    {
    public:
        TriggerAltimeter(StatementModel* model);
        ~TriggerAltimeter();
