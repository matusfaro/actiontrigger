...
#ifndef TriggerAzimuthPitchRoll_HPP_
#define TriggerAzimuthPitchRoll_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerAzimuthPitchRoll: public TriggerValue
    {
    public:
        TriggerAzimuthPitchRoll(StatementModel* model);
...
#endif /* TriggerAzimuthPitchRoll_HPP_ */
