...
#ifndef TriggerCompass_HPP_
#define TriggerCompass_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerCompass: public TriggerValue
    {
    public:
        TriggerCompass(StatementModel* model);
        ~TriggerCompass();
