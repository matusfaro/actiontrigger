...
#ifndef TriggerGravity_HPP_
#define TriggerGravity_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerGravity: public TriggerValue
    {
    public:
        TriggerGravity(StatementModel* model);
        ~TriggerGravity();
