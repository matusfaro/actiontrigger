...
#ifndef TriggerGyroscope_HPP_
#define TriggerGyroscope_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerGyroscope: public TriggerValue
    {
    public:
        TriggerGyroscope(StatementModel* model);
        ~TriggerGyroscope();
