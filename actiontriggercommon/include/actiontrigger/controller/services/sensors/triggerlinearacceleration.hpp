...
#ifndef TriggerLinearAcceleration_HPP_
#define TriggerLinearAcceleration_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerLinearAcceleration: public TriggerValue
    {
    public:
        TriggerLinearAcceleration(StatementModel* model);
...
#endif /* TriggerLinearAcceleration_HPP_ */
