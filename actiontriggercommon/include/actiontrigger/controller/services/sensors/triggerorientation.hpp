...
#ifndef TriggerOrientation_HPP_
#define TriggerOrientation_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerOrientation: public TriggerValue
    {
    public:
        TriggerOrientation(StatementModel* model);
        ~TriggerOrientation();
