...
#ifndef TriggerPressure_HPP_
#define TriggerPressure_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerPressure: public TriggerValue
    {
    public:
        TriggerPressure(StatementModel* model);
        ~TriggerPressure();
