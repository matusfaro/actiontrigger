...
#ifndef TriggerProximity_HPP_
#define TriggerProximity_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerProximity: public TriggerValue
    {
    public:
        TriggerProximity(StatementModel* model);
        ~TriggerProximity();
