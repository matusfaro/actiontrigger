...
#ifndef TriggerRotationMatrix_HPP_
#define TriggerRotationMatrix_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerRotationMatrix: public TriggerValue
    {
    public:
        TriggerRotationMatrix(StatementModel* model);
...
#endif /* TriggerRotationMatrix_HPP_ */
