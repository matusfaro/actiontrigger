...
#ifndef TriggerTemperature_HPP_
#define TriggerTemperature_HPP_
...
namespace actiontrigger
{
    ...
    class TriggerTemperature: public TriggerValue
    {
    public:
        TriggerTemperature(StatementModel* model);
        ~TriggerTemperature();
