...
#ifndef ActionBattery_HPP_
#define ActionBattery_HPP_
...
namespace actiontrigger
{
    ...
    class ActionBattery: public Action
    {
    public:
        ActionBattery(StatementModel* model);
        virtual ~ActionBattery();
        ...
        static std::string chargingStateToString(int state);
    protected:
