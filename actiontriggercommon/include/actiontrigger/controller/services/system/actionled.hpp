...
#ifndef ActionLed_HPP_
#define ActionLed_HPP_
...
namespace actiontrigger
{
    ...
    class ActionLed: public Action
    {
    public:
        ActionLed(StatementModel* model);
        virtual ~ActionLed();
        ...
        static led_color_t getColor(std::string color);
    protected:
