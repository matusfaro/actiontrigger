...
#ifndef WIFIPOWER_HPP_
#define WIFIPOWER_HPP_
...
namespace actiontrigger
{
    ...
    class ActionWifiPower: public Action
    {
    public:
        ActionWifiPower(StatementModel* model);
        virtual ~ActionWifiPower();
